...
• Transformation architecture: Define transformation approach — dbt models / SQL views / orchestrator (Airflow/Composer). Specify order of materialisation (staging → marts → semantic views).
